...
if __name__ == "__main__":
    ...
    for i in range(num_coils):
        ...
        plt.colorbar()
    plt.tight_layout()
    plt.savefig("graphs/all_coil_kspace_magnitude.png")
    plt.show()
    ...
    plt.colorbar()
    plt.tight_layout()
    plt.savefig("graphs/coil1_magnitude_phase.png")
    plt.show()
    ...
    for i in range(num_coils):
        ...
        plt.colorbar()
    plt.tight_layout()
    plt.savefig("graphs/all_coil_magnitude.png")
    plt.show()
    ...
    plt.colorbar()
    plt.tight_layout()
    plt.savefig("graphs/combined_image.png")
    plt.show()